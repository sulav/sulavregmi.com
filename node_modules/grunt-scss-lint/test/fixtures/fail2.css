/*
Sass::SyntaxError: ".large-icon" failed to @extend "%icon".
The selector "%icon" was not found.
Use "@extend %icon !optional" if the extend should be able to fail.


Backtrace:
fail2.scss:3
/Library/Ruby/Gems/2.0.0/gems/sass-3.4.13/lib/sass/tree/visitors/extend.rb:61:in `block in check_extends_fired!'
/Library/Ruby/Gems/2.0.0/gems/sass-3.4.13/lib/sass/util/subset_map.rb:106:in `block in each_value'
/Library/Ruby/Gems/2.0.0/gems/sass-3.4.13/lib/sass/util/subset_map.rb:106:in `each'
/Library/Ruby/Gems/2.0.0/gems/sass-3.4.13/lib/sass/util/subset_map.rb:106:in `each_value'
/Library/Ruby/Gems/2.0.0/gems/sass-3.4.13/lib/sass/tree/visitors/extend.rb:50:in `check_extends_fired!'
/Library/Ruby/Gems/2.0.0/gems/sass-3.4.13/lib/sass/tree/visitors/extend.rb:16:in `visit'
/Library/Ruby/Gems/2.0.0/gems/sass-3.4.13/lib/sass/tree/root_node.rb:39:in `css_tree'
...
body:before {
  ...
  content: "Sass::SyntaxError: \".large-icon\" failed to @extend \"%icon\".\A The selector \"%icon\" was not found.\A Use \"@extend %icon !optional\" if the extend should be able to fail.\A "; }
